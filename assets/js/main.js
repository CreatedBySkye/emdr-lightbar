...
function change() {
    document.body.style = "background-color:black; background-image:none";
}

function changeBack() {
    document.body.style = "background-color:black; background-image: url('./assets/images/clouds3.jpg')"
}
async function next() {
...
async function setUpLightbar() {
    ...
    for (let i = 0; i < CSS_COLOR_NAMES.length; i++) {
        ...
        let firstLetterRecapitalized = colorWithSpaces.charAt(0).toUpperCase() + colorWithSpaces.slice(1);
...
function frequencyChange() {
    document.getElementById("frequency_value").innerText = parseInt(document.forms["settings"]["frequency"].value);
}
